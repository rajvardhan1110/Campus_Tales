...
// Icon for "No Posts Found" - No hover effect (non-clickable)
...
// Icon for Dashboard Button - With hover effect (clickable)
    ...
    <div className="flex h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 text-gray-800">
      ...
      <div className={`flex-1 flex flex-col transition-all duration-300 ${
        ...
        <main className="flex-1 flex flex-col p-6 overflow-hidden">
          ...
          {/* Fixed Title - No hover effect (non-clickable) */}
          ...
          <div className="relative flex-1 overflow-y-auto">
            {loading ? (
              // Loading state - No hover effect (non-clickable)
              <div className="text-center text-gray-600 font-medium text-xl">
                Loading posts...
              </div>
            ) : myPosts.length === 0 ? (
              // No posts state - No hover effect (non-clickable)
              ...
              // Posts grid - Cards are clickable with hover effects
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {myPosts.map(post => {
                  ...
                  return (
                    ...
                    >
                      {/* Card Header - Clickable as part of card */}
                      ...
                      {/* Card Content - Clickable as part of card */}
                      <div className="p-6 space-y-4">
                        <div className="flex flex-wrap gap-2">
                          {/* Badges - No hover effects (non-clickable) */}
                      ...
                      {/* Card Footer - Clickable as part of card */}
          ...
          {/* Fixed Button Area - Button is clickable with hover effects */}
          {!loading && (
