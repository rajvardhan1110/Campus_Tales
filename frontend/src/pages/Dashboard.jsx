...
<div className="p-5 flex flex-wrap justify-center items-center gap-4 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-b-lg shadow-md">
  ...
  <div className="flex flex-wrap gap-4 justify-center">
    ...
    <select
      ...
      onChange={handleFilterChange}
      className="px-4 py-2 rounded-md border border-gray-300 ocus:outline-none focus:ring-2 focus:ring-indigo-400 focus:border-indigo-400"
    >
      ...
      <option value="Off-Campus">Off-Campus</option>
        ...
        <div className="p-5 flex justify-center">
          <button
            ...
            className="px-4 py-2 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white px-6 py-2 rounded-lg hover:bg-gradient-to-r hover:from-indigo-300 hover:via-purple-300 hover:to-pink-300 hover:text-black transition font-medium"
          >
            Create Post
          </button>
        </div>
        ...
        <div className="p-5 flex-1 overflow-y-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {experiences.map((exp) => (
            ...
            >
              ...
              <p className="text-sm text-gray-700">
                <span className="font-semibold text-indigo-600">Branch:</span> {exp.branch || "N/A"}
              </p>
              <p className="text-sm text-gray-700">
                <span className="font-semibold text-indigo-600">Year:</span> {exp.year || "N/A"}
              </p>
              <p className="text-sm text-gray-700">
                <span className="font-semibold text-indigo-600">Passout Year:</span> {exp.passoutYear || "N/A"}
              </p>
              <p className="text-sm text-gray-700">
                <span className="font-semibold text-indigo-600">Type:</span> {exp.type || "N/A"}
              </p>
              <p className="text-sm text-gray-700">
                <span className="font-semibold text-indigo-600">Placement Type:</span> {exp.placementType || "N/A"}
              </p>
